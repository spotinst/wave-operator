...
func (m *MockManager) GetApplicationInfo(applicationID string, metricsAggregationState sparkapi.StageMetricsAggregationState, log logr.Logger) (*sparkapi.ApplicationInfo, error) {
	m.ctrl.T.Helper()
