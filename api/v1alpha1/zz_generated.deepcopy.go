...
func (in *SparkApplicationData) DeepCopyInto(out *SparkApplicationData) {
	*out = *in
	out.SparkProperties = in.SparkProperties
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WaveComponentOwner) DeepCopyInto(out *WaveComponentOwner) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WaveComponentOwner.
func (in *WaveComponentOwner) DeepCopy() *WaveComponentOwner {
	if in == nil {
		return nil
	}
	out := new(WaveComponentOwner)
	in.DeepCopyInto(out)
	return out
}
